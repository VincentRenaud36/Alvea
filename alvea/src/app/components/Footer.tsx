...
const Footer: React.FC<FooterProps> = ({ isLoggedIn }) => {
  const jellyBeanColor = "#1F7A93"; // Couleur Jelly-Bean
      ...
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="hidden md:grid grid-cols-3 items-start gap-8">
          ...
          <div className="flex flex-col items-center md:items-start">
            <Image
              src="/Images/alvea-logo-text.png"
              alt="Alvéa Logo"
              width={140}
              height={50}
              priority
        ...
        {/* Footer Bas */}
        <div className="mt-8 border-t border-gray-200 pt-4 text-center md:text-left">
          <p className="text-sm">
